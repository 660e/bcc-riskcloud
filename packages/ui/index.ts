import CloudMarkerCollection from './src/cloud-marker-collection/index.vue';
...
export { CloudMarkerCollection, ErrorMessage403, ErrorMessage404, ErrorMessage500, MapAnnotation, OnePicture, SensitiveTargets };
